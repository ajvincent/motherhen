 ...
 */
export async function shouldReplaceHatchedEgg(integration, pathToVanilla) {
    console.log(`
 ...
 */
export async function replaceHatchedEgg(fullPathToMozconfig, replaceHatchedEggName) {
    await replaceInFile({
