 ...
 */
export default
async function pickConfigLocation() : Promise<PathWithUncreatedDirs>
{
  console.log("\n" + `
...
`.trim());
  ...
  return pickFileToCreate(
    "Please choose an existing directory which will contain (as an ancestor) your configuration file.",
    "Please enter a relative path from this directory to the Motherhen configuration file.",
    process.cwd(),
