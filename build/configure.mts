...
import getConfiguration, {type Configuration } from "./target/Configuration.mjs";
...
) : Promise<void>
{
...

  {
    ...
    const data = await response.json() as { "mozilla-unified": { "zstd-max": { "path" : string } } };
